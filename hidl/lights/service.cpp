...
#define LOG_TAG "android.hardware.light@2.0-service.blue"
...
const static std::string kBacklight1Path = "/sys/devices/i2c-10/10-0040/leds/lcd-backlight_1/brightness";
const static std::string kBacklight2Path = "/sys/devices/i2c-10/10-0040/leds/lcd-backlight_2/brightness";
